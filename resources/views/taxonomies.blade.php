@php
    ...
    $terms = App\Models\Taxonomy::where('type', $taxonomyType)->paginate(10);
    $term = $id ? App\Models\Taxonomy::find($id) : null;
    $parents = $taxonomyType['hierarchical']
        ? App\Models\Taxonomy::where('type', $taxonomyType['name'])->where('id', '!=', $id)->get()
        : collect();
@endphp
